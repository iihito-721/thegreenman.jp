...
import { getContext, executeAsync } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CR7KB3NH.mjs')
  },
  {
    name: "the-rocker-room-slug",
    path: "/the-rocker-room/:slug()",
    component: () => import('./_slug_-trGuqmWg.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CDvYTbzK.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DAaO-zrQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DmP22jrt.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DGHQVpAP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CsC-4aXp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C0HcI6cN.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-LHPsn2QJ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BamSvz9o.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CFmn-nO5.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DGg48_J4.mjs'));
...
export { useNuxtApp as a, asyncDataDefaults as b, createError as c, useRouter as d, entry$1 as default, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
