...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createError, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/@vue/shared/dist/shared.cjs.js';
import { readdirSync, readFileSync } from 'node:fs';
import matter from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/gray-matter/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/vue/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/unhead/dist/utils.mjs';
import { isAbsolute } from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file:///Users/nats/Sites/thegreenman-dev/node_modules/db0/dist/connectors/node-sqlite.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/nats/Sites/thegreenman-dev/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/nats/Sites/thegreenman-dev","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/nats/Sites/thegreenman-dev/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/nats/Sites/thegreenman-dev/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/nats/Sites/thegreenman-dev/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/nats/Sites/thegreenman-dev/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/rockerRoom/sql_dump.txt": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/nats/Sites/thegreenman-dev/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _QkG9NRH_4a7qJ3zUtsixnMtDcQ2N3027sJxiGMs1Xc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/nats/Sites/thegreenman-dev";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"サッカーキットを起点に、フットボールの文化と美意識を写真とストーリーで記録するインディペンデント・ビジュアルメディア、THE GREEN MAN。"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Babylonica&family=DotGothic16&family=Fredericka+the+Great&display=swap"}],"style":[],"script":[{"src":"https://cdn.jsdelivr.net/npm/lenis@1.3.8/dist/lenis.min.js"},{"src":"https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js"},{"src":"https://cdnjs.cloudflare.com/ajax/libs/three.js/r83/three.min.js"},{"src":"https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js"},{"innerHTML":"\n            WebFont.load({\n              google: {\n                families: ['Babylonica', 'DotGothic16', 'Fredericka the Great']\n              },\n              loading: function() {\n                document.documentElement.classList.add('wf-loading');\n              },\n              active: function() {\n                document.documentElement.classList.remove('wf-loading');\n                document.documentElement.classList.add('wf-active');\n              },\n              inactive: function() {\n                document.documentElement.classList.remove('wf-loading');\n                document.documentElement.classList.add('wf-inactive');\n              }\n            });\n          "},{"src":"/scripts/hover.js"},{"src":"/scripts/tgm.js"}],"noscript":[],"title":"THE GREEN MAN | Football Kit, Photography & Culture"};
...
const _H3lfOlKMTx5HyoWLMEFM05yPc0pdGSgSiY0J2oNd9E = (nitroApp) => {
...
const plugins = [
  _QkG9NRH_4a7qJ3zUtsixnMtDcQ2N3027sJxiGMs1Xc,
_H3lfOlKMTx5HyoWLMEFM05yPc0pdGSgSiY0J2oNd9E
];
...
const getServerEntry = () => import('file:///Users/nats/Sites/thegreenman-dev/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/nats/Sites/thegreenman-dev/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _mKsN7n = eventHandler(async (event) => {
  ...
  return await import('file:///Users/nats/Sites/thegreenman-dev/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const checksums = {
  "rockerRoom": "v3.5.0--7KF2gzXBbHLduVIiCN_88aIZm5EgKtcEC18HAlZmPDI"
};
...
const _8i61w3 = eventHandler(async (event) => {
...
const _lazy_8hWTZn = () => Promise.resolve().then(function () { return posts$1; });
const _lazy_EZN0H5 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/posts', handler: _lazy_8hWTZn, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_EZN0H5, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _mKsN7n, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _8i61w3, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_EZN0H5, lazy: true, middleware: false, method: undefined }
];
